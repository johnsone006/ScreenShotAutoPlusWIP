namespace ScreenShotAutoPlus
{
    internal static class UIA_PropertyIds
    {
        ...
        public const int UIA_IsSelectionPattern2AvailablePropertyId = 30168;

        public const int UIA_Selection2FirstSelectedItemPropertyId = 30169;

        public const int UIA_Selection2LastSelectedItemPropertyId = 30170;

        public const int UIA_Selection2CurrentSelectedItemPropertyId = 30171;

        public const int UIA_Selection2ItemCountPropertyId = 30172;
